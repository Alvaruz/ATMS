...
urlpatterns = [
    ...
    path('comunicaciones/estadisticas_dia/', views.estadisticas_dia, name='comunicaciones_estadisticas_dia'),
    path('comunicaciones/estadisticas_mes/', views.estadisticas_mes, name='comunicaciones_estadisticas_mes'),
